...
class Contact_GetContact_Test extends PHPUnit_Framework_TestCase {
	...
	*/
			...
			* 	TEST GET CONTACT
			*
			*	@description 		Tests successful getContact function
			*		
			*	@return BOOL 		BOOL
			*/
			...
			public function testGetContact(){
				...
				// Do the test
				$this->assertEquals( $return_obj, $this->mockSoap->getContact(1234) );

			} 

			/*
			* 	TEST GET CONTACT - NO CONTACT
			*
			*	@description 		Tests unsuccessful getContact function contact doesn't exist
			*		
			*	@return BOOL 		BOOL
			*/
